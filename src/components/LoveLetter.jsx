  ...
  return (
    <div ref={containerRef} style={{
      ...
      <div ref={(el) => itemsRef.current.push(el)} style={{
        ...
        <img src="/putri 9.jpeg" alt="Janii" style={{ width: '100%', height: '100%', objectFit: 'cover' }}
      ...
      <div ref={(el) => itemsRef.current.push(el)} style={{
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
          ...
          <p style={{
            ...
            "Happy 20th Birthday, my favorite person. Aku selalu berdoa supaya di usiamu yang baru ini, Janii bisa makin bahagia, selalu merasa dicintai, dan makin percaya sama potensi diri sendiri. No matter what comes next, I'll always be right here supporting you."
          </p>
        </div>
      </div>
      ...
      <p ref={(el) => itemsRef.current.push(el)} style={{ marginBottom: 14, fontWeight: 500 }}>
        I feel super lucky to see you grow into such a kind, smart, and wonderful person. Semoga di umur 20 ini, semua impian dan cita-cita yang lagi Janii perjuangkan bisa perlahan terwujud satu per satu.
      </p>

      {/* Paragraph 4 */}
      <p ref={(el) => itemsRef.current.push(el)} style={{ marginBottom: 14, fontWeight: 500 }}>
        Stay healthy, stay humble, and keep spreading that bright smile of yours. Once again, happy 20th birthday, Janii! Let's make more beautiful memories together. 💖
      </p>
      ...
      <div ref={(el) => itemsRef.current.push(el)} style={{
        ...
        <p style={{
          ...
          Happy 20th Birthday, Janii! Thank you for being my favorite part of every day. 🎂✨💖
        </p>
      </div>
    </div>
  );
...
function ImpianTab() {
  ...
  const dreams = [
    ...
    },
    {
      ...
      text: 'Selalu ada di samping Janii untuk mendukung setiap impian, karir, dan passion yang kamu suka. I will always be your biggest supporter.',
  ...
  return (
    <div ref={containerRef} style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        {[
          <span>Semoga di usiamu yang ke-20 ini, Janii selalu sehat, selalu merasa tenang, dan makin dilancarkan setiap urusannya. 🤲🏻💖</span>,
          <span>May your beautiful, genuine smile always bring happiness to everyone around you and brighten up your days! ✨</span>,
          <span>Semoga semua wishlist, impian, dan hal-hal yang lagi Janii usahakan sekarang bisa terwujud satu per satu dengan indah. 🌸</span>,
